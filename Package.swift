...
// Generated by scripts/release/swift-dist.mjs from packages/ios at version 0.1.0-beta.3.
...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "core_engineFFI",
            url: "https://github.com/sinua-dev/sinua-swift/releases/download/0.1.0-beta.3/core_engineFFI.xcframework.zip",
            checksum: "210535873d1fcb6e991b2d138565a5d2508efac36c9f4a77f6d7118137f9495f"
        ),
        .target(
            name: "CoreEngine",
