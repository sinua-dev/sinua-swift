...
// Generated by scripts/release/swift-dist.mjs from packages/ios at version 0.1.0-beta.1.
...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "core_engineFFI",
            url: "https://github.com/sinua-dev/sinua-swift/releases/download/0.1.0-beta.1/core_engineFFI.xcframework.zip",
            checksum: "c2d1922506f978bd817de29ee7ca9604a70628af4c2b11252f80bf3505511fa8"
        ),
        .target(
            name: "CoreEngine",
