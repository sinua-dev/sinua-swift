...
// Generated by scripts/release/swift-dist.mjs from packages/ios at version 0.1.0-beta.4.
...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "core_engineFFI",
            url: "https://github.com/sinua-dev/sinua-swift/releases/download/0.1.0-beta.4/core_engineFFI.xcframework.zip",
            checksum: "7250230c335d6b292ea029efef65aac6b59b8f68899a3aa3ef09578d5d2d8b4d"
        ),
        .target(
            name: "CoreEngine",
